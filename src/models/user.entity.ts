...
export interface UserSequelizeModel extends Model<UserModel>, UserModel {
}

export type UserStatic = typeof Model & {
    new(value?: object, object?: BuildOptions): UserSequelizeModel;
};

export const UserFactory = (name: string, sequelize: Sequelize): UserStatic => {
    const attributes: ModelAttributes<UserSequelizeModel> = {
        id: {
    ...
    } as unknown as ModelAttributes<UserSequelizeModel>;
    let table = sequelize.define(name, attributes, { tableName: name, freezeTableName: true, timestamps: true }) as UserStatic;
